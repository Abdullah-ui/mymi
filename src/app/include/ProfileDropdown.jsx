      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-gray-800 rounded-lg shadow-2xl border border-gray-700 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="px-4 py-3 border-t border-gray-700 space-y-2">
            <button onClick={() => {redirect("/dashboard")}} className="w-full text-left px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition-colors duration-150 flex items-center space-x-2">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
